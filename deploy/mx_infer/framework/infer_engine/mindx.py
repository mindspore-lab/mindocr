...
from deploy.mx_infer.utils import check_valid_file, suppress_stdout
...
class MindXModel(ModelBase):
    ...
    def get_gear(self):
        ...
        raise ValueError(f"Get model_gear failed for {self.model_path}. Please Check ATC conversion process!")
