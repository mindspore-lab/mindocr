...
class RecVGG(nn.Cell):
    r'''RecVGG is the VGG Network structure for recognition backbone, based on [Very Deep Convolutional Networks for Large-Scale Image Recognition](https://arxiv.org/abs/1409.1556) paper.
