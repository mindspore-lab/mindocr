...
from mindocr.models.backbones.layoutxlm.downloader import (
...
class PretrainedTokenizerBase(SpecialTokensMixin):
    ...
    # tokenizer_config_file = TOKENIZER_CONFIG_NAME  # TODO: from paddlenlp.utils.env import TOKENIZER_CONFIG_NAME
    tokenizer_config_file = "tokenizer_config.json"
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *args, from_hf_hub=False, subfolder=None, **kwargs):
        ...
        cache_dir = resolve_cache_dir(pretrained_model_name_or_path, from_hf_hub, cache_dir)  # TODO: from .utils import resolve_cache_dir
        vocab_files = {}
        init_configuration = {}
        ...
        for file_id, file_path in vocab_files.items():
            ...
            if from_hf_hub:
                ...
                if os.path.exists(path):
                    ...
                    try:
                        if not url_file_exists(file_path):  # TODO: from paddlenlp.utils.downloader import url_file_exists
                            logger.warning(f"file<{file_path}> not exist")
                            resolved_vocab_files[file_id] = None
                            continue
                        resolved_vocab_files[file_id] = get_path_from_url_with_filelock(file_path, cache_dir)  # TODO: from paddlenlp.utils.downloader import get_path_from_url_with_filelock
