...
def get_args():
    ...
    parser.add_argument('--rec_char_dict_path', type=str, default='', required=False, help='Character dict file path fo r recognition models.')

    parser.add_argument('--det_res_save_dir', type=str, default='', required=False, help='Saving dir for detection results.')
    parser.add_argument('--rec_res_save_dir', type=str, default='', required=False, help='Saving dir for recognition results.')
    parser.add_argument('--pipeline_res_save_dir', type=str, default='', required=False, help='Saving dir for pipeline inference results.')
    parser.add_argument('--vis_det_save_dir', type=str, default='', required=False, help='Saving dir for visualization of detection results.')
    parser.add_argument('--vis_pipeline_save_dir', type=str, default='', required=False, help='Saving dir for visualization of pipeline inference results.')
    parser.add_argument('--vis_font_path', type=str, default='', required=False, help='Font file path for recognition model.')
    parser.add_argument('--save_pipeline_crop_res', type=bool, default=False, required=False, help='Whether save the images cropped during pipeline.')
    parser.add_argument('--pipeline_crop_save_dir', type=str, default='', required=False, help='Saving dir for images cropped during pipeline.')
