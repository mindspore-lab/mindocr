...
def parse_args():
    ...
    parser.add_argument('--det_config_path', type=str, default='configs/det/dbnet/db_r50_icdar15.yaml',
    ...
    parser.add_argument('--crop_save_dir', type=str, default='predict_result/crop', required=False,
                        help='Saving dir for images cropped during prediction pipeline.')
    parser.add_argument('--result_save_dir', type=str, default='predict_result/ckpt_pred_result.txt', required=False,
