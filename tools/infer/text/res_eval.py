'''
Uasage Example:
    $ python tools/infer/text/res_eval.py --draw_img_save_dir inference_results/rec_results.txt --rec_gt_path /Users/Samit/Data/datasets/ic15/rec/test/rec_gt.txt
'''
