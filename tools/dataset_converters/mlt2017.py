...
class MLT2017_Converter(object):
    '''
    Format annotation to standard form for MLT2017 dataset. The original annotation file is a COCO-format JSON annotation file. 
    ...
    0060001.jpg	[{"transcription": "the", "points":[[153, 347], ..., [177, 357]], 'beizer':[123,...,567]}]
    '''
    ...
    def _format_det_label(self, image_dir, label_path, output_path):
        ...
        with open(output_path, 'w') as out_file:
            ...
            for annot in tqdm.tqdm(annotations, total=len(annotations)):
                ...
                img_path = os.path.join(image_dir, '{:07d}'.format(image_id)+ ".jpg")
