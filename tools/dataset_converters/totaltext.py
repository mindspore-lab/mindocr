...
class TOTALTEXT_Converter(object):
    '''
    Format annotation to standard form for total text dataset. The original annotation files are txt files named after the image names. An example of txt file:
    ...
    img1001.jpg	[{"transcription": "the", "points": [[153, 347], ..., [177, 357]]}, {"transcription": "alpaca", "points": [[184, 293], ..., [202, 317]]}]
    ...
    '''
            ...
            for label_fp in label_paths:
                ...
                with open(label_fp, 'r', encoding='utf-8-sig') as f:
                    ...
                    for line in f.readlines():
                        ...
                        transcriptions = transcriptions.split(':')[-1].replace('[', '').replace(']', '').strip().split(' ') # transcription looks like [u'xxx']
