...
| **dataset** | Dataset configuration | | For details, please refer to [Data document](https://github.com/mindspore-lab/mindocr/blob/main/mindocr/data/README.md) |
