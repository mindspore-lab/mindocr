...
When evaluating the PaddleOCR or MMOCR series models, please refer to [Third-Party Model Support List](./models_list_thirdparty_en.md) to use the corresponding dictionary.
