...
| 字段 | 用途 | 默认值 | 备注 |
| :---- | :---- | :---- | :---- |
| scheduler | 学习率调整策略名 | 'constant' | 目前支持 'constant', 'cosine_decay', 'step_decay', 'exponential_decay', 'polynomial_decay', 'multi_step_decay' |
| min_lr | 学习率最小值 | 1e-6 | \ |
| lr | 学习率峰值 | 0.01 | \ |
| num_epochs | 最大训练epoch数 | 200 | \ |
| warmup_epochs | 学习率递增epoch数 | 3 | \ |
| decay_epochs | 学习率递减epoch数 | 10 | \ |
